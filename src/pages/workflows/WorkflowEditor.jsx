    ...
    return (
        <div className="workflow-editor-theme" style={{ overflow: 'visible' }}>
            ...
            <div style={{ margin: '20px 40px 0 40px' }}>
                <div className="glass-panel animate-fade-in" style={{ padding: '16px 20px', borderRadius: '16px', border: '1px solid var(--border-color)', background: 'linear-gradient(135deg, rgba(99, 102, 241, 0.04) 0%, rgba(16, 185, 129, 0.04) 100%)', backdropFilter: 'blur(8px)' }}>
